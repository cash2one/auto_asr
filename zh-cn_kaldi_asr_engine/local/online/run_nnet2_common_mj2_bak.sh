...
if [ $stage -le 1 ]; then
  ...
  utils/subset_data_dir.sh data/train_960_hires 158000 data/train_mixed_hires_30k
  utils/subset_data_dir.sh data/train_960_hires 316000 data/train_mixed_hires_60k
fi
...
if [ $stage -le 4 ]; then
  ...
  steps/online/nnet2/train_diag_ubm.sh --cmd "$train_cmd" --nj 20 --num-frames 700000 \
